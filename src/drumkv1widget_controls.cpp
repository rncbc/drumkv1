...
void loadControlParamComboBox (
	QComboBox *pComboBox, drumkv1_controls::Type ctype )
{
...
static
QString controlParamName ( drumkv1_controls::Type ctype, unsigned short param )
{
	QMap<unsigned short, QString> map;
	...
	const QStyleOptionViewItem& /*option*/, const QModelIndex& index ) const
{
	...
	case 1: // Type.
	{
		...
		pComboBox->setEditable(false);
		pComboBox->addItem(drumkv1_controls::textFromType(drumkv1_controls::CC));
		pComboBox->addItem(drumkv1_controls::textFromType(drumkv1_controls::RPN));
		pComboBox->addItem(drumkv1_controls::textFromType(drumkv1_controls::NRPN));
		pComboBox->addItem(drumkv1_controls::textFromType(drumkv1_controls::CC14));
		pEditor = pComboBox;
		break;
	}
	...
	case 3: // Subject.
	{
		...
		for (uint32_t i = 0; i < drumkv1::NUM_PARAMS; ++i)
			pComboBox->addItem(drumkv1_param::paramName(drumkv1::ParamIndex(i)));
		pEditor = pComboBox;
		break;
	}
