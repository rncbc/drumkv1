	...
	drumkv1_controls::Type ctype, QWidget *pParent )
{
	...
	if (bEditable) {
		const drumkv1widget_controls::Names::ConstIterator& iter_end = map.constEnd();
		drumkv1widget_controls::Names::ConstIterator iter = map.constBegin();
...
// ctor.
drumkv1widget_controls_item_delegate::drumkv1widget_controls_item_delegate (
...
QSize drumkv1widget_controls_item_delegate::sizeHint (
...
QWidget *drumkv1widget_controls_item_delegate::createEditor ( QWidget *pParent,
	const QStyleOptionViewItem& /*option*/, const QModelIndex& index ) const
{
	...
	qDebug("drumkv1widget_controls_item_delegate::createEditor(%p, %d, %d) = %p",
...
void drumkv1widget_controls_item_delegate::setEditorData (
	QWidget *pEditor, const QModelIndex& index ) const
{
#ifdef CONFIG_DEBUG_0
	qDebug("drumkv1widget_controls_item_delegate::setEditorData(%p, %d, %d)",
...
void drumkv1widget_controls_item_delegate::setModelData ( QWidget *pEditor,
...
void drumkv1widget_controls::loadControls ( drumkv1_controls *pControls )
{
	...
	for ( ; iter != iter_end; ++iter) {
		...
		const drumkv1::ParamIndex index = drumkv1::ParamIndex(iter.value());
