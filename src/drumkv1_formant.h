...
#ifndef __drumkv1_formant_h
#define __drumkv1_formant_h
...
class drumkv1_formant
{
public:

	// ctor.
	drumkv1_formant(float srate = 44100.0f)
		: m_srate(srate) { reset(); }
...
#endif	// __drumkv1_formant_h

// end of drumkv1_formant.h
