...
static const char *g_pszDefName = QT_TRANSLATE_NOOP("drumkv1widget_config", "(default)");
		...
		m_pDrumkUi(pDrumkUi)
{
	...
	QDialog::setWindowIcon(QIcon(":/images/drumkv1.png"));
#endif
...
void drumkv1widget_config::programsAddPresetItems (void)
{
	// Get the presets...
...
void drumkv1widget_config::presetsAddBankItem (void)
{
...
void drumkv1widget_config::presetsAddItem (void)
{
	drumkv1_config *pConfig = drumkv1_config::getInstance();
	if (pConfig) {
...
void drumkv1widget_config::presetsRenameItem (void)
{
...
void drumkv1widget_config::presetsRemoveItem (void)
{
	QTreeWidgetItem *pItem = m_ui.PresetsTreeWidget->currentItem();
	if (pItem)
		delete pItem;
...
void drumkv1widget_config::presetsImportItems (void)
{
	drumkv1_config *pConfig = drumkv1_config::getInstance();
	if (pConfig == nullptr)
		return;
...
void drumkv1widget_config::presetsExportItems (void)
{
	drumkv1_config *pConfig = drumkv1_config::getInstance();
	if (pConfig == nullptr)
		return;
...
// programs janitor slots.
void drumkv1widget_config::presetsCurrentChanged (void)
{
	stabilize();
}


void drumkv1widget_config::presetsContextMenuRequested ( const QPoint& pos )
{
	...
	action = menu.addAction(QIcon(":/images/drumkv1_preset.png"),
...
void drumkv1widget_config::presetsChanged (void)
{
	++m_iDirtyPresets;
...
void drumkv1widget_config::presetsActivated (void)
{
...
void drumkv1widget_config::tuningChanged (void)
{
	++m_iDirtyTuning;
...
void drumkv1widget_config::customChanged (void)
{
	++m_iDirtyCustom;
...
void drumkv1widget_config::editCustomColorThemes (void)
{
	drumkv1_config *pConfig = drumkv1_config::getInstance();
	if (pConfig == nullptr)
		return;

	drumkv1widget_palette form(this);
...
void drumkv1widget_config::customColorThemeChanged ( int iCustomColorIndex )
{
	drumkv1_config *pConfig = drumkv1_config::getInstance();
	if (pConfig == nullptr)
		return;
...
void drumkv1widget_config::customStyleThemeChanged ( int iCustomStyleIndex )
{
	drumkv1_config *pConfig = drumkv1_config::getInstance();
	if (pConfig == nullptr)
		return;
...
void drumkv1widget_config::resetCustomColorThemes (
...
void drumkv1widget_config::resetCustomStyleThemes (
...
bool drumkv1widget_config::setComboBoxCurrentItem (
...
QString drumkv1widget_config::comboBoxCurrentItem ( QComboBox *pComboBox )
{
	QString sData;
