...
// janitor slots.
void drumkv1widget_config::programsCurrentChanged ( QTreeWidgetItem *, QTreeWidgetItem * )
{
	stabilize();
}


void drumkv1widget_config::programsDoubleClicked ( QTreeWidgetItem *pItem, int iColumn )
{
