...
{
	m_pImpl = new drumkv1_control::Impl();
}
...
bool drumkv1_control::isPending (void) const
{
	return m_pImpl->is_pending();
}


bool drumkv1_control::process ( const drumkv1_control::Event& event )
{
	return m_pImpl->process(event);
}


bool drumkv1_control::dequeue ( drumkv1_control::Event& event )
{
