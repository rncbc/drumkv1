...
//-------------------------------------------------------------------------
// drumkv1_wave - smoothed (integrating oversampled) oscillator
...
public:
	...
	// ctor.
	drumkv1_oscillator(const drumkv1_wave& wave)
		: m_wave(wave), m_phase(0.0f) {}

	// wave accessor.
	const drumkv1_wave& wave() const
		{ return m_wave; }
