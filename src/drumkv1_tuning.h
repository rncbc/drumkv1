...
#ifndef __drumkv1_tuning_h
#define __drumkv1_tuning_h
...
public:
	...
	// Default ctor.
	drumkv1_tuning(float refPitch = REF_PITCH, int refNote = REF_NOTE);
...
#endif	// __drumkv1_tuning_h

// end of drumkv1_tuning.h
