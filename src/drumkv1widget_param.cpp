...
public:
	...
	// Constructor.
	drumkv1widget_param_style(drumkv1widget_param *widget)
...
QIcon drumkv1widget_param_style::g_icon;
...
{
	drumkv1widget_param::setStyle(new drumkv1widget_param_style(this));
#if 0
