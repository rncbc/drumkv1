...
#ifndef __drumkv1widget_preset_h
#define __drumkv1widget_preset_h
...
class drumkv1widget_preset : public QWidget
{
	Q_OBJECT
...
public:
	...
	// Constructor.
	drumkv1widget_preset(QWidget *pParent = nullptr);
	...
	void reloadPresets(drumkv1_presets *pPresets = nullptr);
...
private:
	...
	drumkv1widget_presets::ComboBox *m_pComboBox;
...
#endif  // __drumkv1widget_preset_h

// end of drumkv1widget_preset.h
