...
QString drumkv1_preset::paramName ( drumkv1::ParamIndex index )
{
	return drumkv1_default_params[index].name;
}


float drumkv1_preset::paramDefaultValue ( drumkv1::ParamIndex index )
{
...
void drumkv1_preset::loadElements (
	drumkv1 *pDrumk, const QDomElement& eElements,
	const drumkv1_preset::map_path& mapPath )
{
	if (pDrumk == NULL)
		return;
...
void drumkv1_preset::saveElements (
