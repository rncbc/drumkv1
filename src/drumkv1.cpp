...
public:
	...
	drumkv1_list<drumkv1_elem> node;
};
...
const char *drumkv1_elem::sampleFile (void) const
{
...
float *drumkv1_elem::paramPort ( drumkv1::ParamIndex index )
{
	float *pfParam = 0;
