...
#ifndef __drumkv1widget_presets_h
#define __drumkv1widget_presets_h
...
//----------------------------------------------------------------------------
// drumkv1widget_presets -- Custom (tree) widget.

class drumkv1widget_presets : public QTreeWidget
{
	Q_OBJECT
...
public:
	...
	// ctor.
	drumkv1widget_presets(QWidget *pParent = nullptr);
	// dtor.
	~drumkv1widget_presets();
...
// custom combo-box decl.
//
class drumkv1widget_presets::ComboBox : public QComboBox
{
	Q_OBJECT
...
public:
	...
	drumkv1widget_presets *presetsView() const;
...
private:
	...
	drumkv1widget_presets *m_pPresetsView;
};


#endif	// __drumkv1widget_presets_h

// end of drumkv1widget_presets.h
