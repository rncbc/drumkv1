...
//-------------------------------------------------------------------------
// drumkv1widget_preset - Custom preset-box widget.
//

// Constructor.
drumkv1widget_preset::drumkv1widget_preset ( QWidget *pParent )
	: QWidget(pParent)
{
	m_pNewButton    = new QToolButton();
	m_pOpenButton   = new QToolButton();
	m_pComboBox     = new drumkv1widget_presets::ComboBox();
...
void drumkv1widget_preset::clearPreset (void)
{
	++m_iInitPreset;
...
bool drumkv1widget_preset::queryPreset (void)
{
	if (m_iInitPreset == 0)
		return true;
...
void drumkv1widget_preset::activatePreset ( const QString& sPreset )
{
...
void drumkv1widget_preset::loadPreset ( const QString& sPreset )
{
	if (sPreset.isEmpty())
		return;
...
QTreeWidgetItem *drumkv1widget_preset::presetItem ( const QString& sPreset ) const
{
	return m_pPresetsView->presetItem(sPreset);
}


void drumkv1widget_preset::setBankItem ( const QString& sBank, int iPreset )
{
	m_pPresetsView->setBankItem(sBank, iPreset);
}


QTreeWidgetItem *drumkv1widget_preset::bankItem ( const QString& sBank ) const
{
	return m_pPresetsView->bankItem(sBank);
}


// end of drumkv1widget_preset.cpp
