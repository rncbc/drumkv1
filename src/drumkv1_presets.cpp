...
//-------------------------------------------------------------------------
// drumkv1_presets - Bank/presets database class (singleton).
//
...
void drumkv1_presets::Bank::add_preset ( const QString& preset_name )
{
...
void drumkv1_presets::Bank::remove_preset ( const QString& preset_name )
{
	m_preset_list.removeAll(preset_name);
}


void drumkv1_presets::Bank::clear_presets (void)
{
	m_preset_list.clear();
}
...
// bank managers
drumkv1_presets::Bank *drumkv1_presets::find_bank (
...
drumkv1_presets::Bank *drumkv1_presets::find_preset_bank (
...
drumkv1_presets::Bank *drumkv1_presets::add_bank (
...
// preset managers
drumkv1_presets::Preset *drumkv1_presets::find_preset (
	const QString& preset_name ) const
{
...
drumkv1_presets::Preset *drumkv1_presets::add_preset (
...
void drumkv1_presets::clear_presets (void)
{
